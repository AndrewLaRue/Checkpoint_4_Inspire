...
export class Todo {
  ...
  get Template() {
    return `
      <li id="${this.id}" class="ms-4 d-flex justify-content-between align-items-center">
        <input type="checkbox" ${this.completed ? 'checked' : ''} onchange="app.todosController.toggle('${this.id}')">
